...
`docs/findings-cli-spec-gaps.md` is now:
...
- **Goal 11 A1 branch-create guard.** Goal 11 deliberately required
  `branch create` to remain in `docs/findings-cli-spec-gaps.md` as unrelated
...
A1. **The branch-create agent-format debt is removed from
    `docs/findings-cli-spec-gaps.md`, without clearing unrelated debt.**

...
#
# Runs only the *active* goal's gates plus the orchestrator-owned
# rigor sweep. Prior-goal regression is deliberately NOT checked here
# — that work is delegated to scripts/completion-check.sh, which runs:
...
# Resolve active goal. If unknown / stale, defer to the full
# orchestrator to bootstrap.
ACTIVE=""

...
_Auto-generated by `scripts/update-state.sh`. Do not hand-edit._
...
| UC-025 | Compare two revisions | ○ NOT STARTED | 0/0 |
| UC-026 | Revert to a previous revision | ○ NOT STARTED | 0/0 |

...
| `priority`     | `P0 \| P1 \| P2`          | no       | —       | Omit for P2-ish cleanup. `P0` = data-integrity / chain-blocker; `P1` = pre-beta hazard; `P2` = post-beta cleanup.      |
...
| `was`          | repo-rooted path          | no       | —       | Previous goal path, usually `goals/<n>-<name>.md`, when a promoted goal dissolved back into the findings queue.        |

...
_Auto-generated 2026-05-19T10:07:50Z. Do not hand-edit; use blockers.md for overrides._

```
TASK: Add CLI E2E for UC-014 (gate 1.4).
  - Read: docs/usecases/UC-014-search-usecases.md
  - Create tests/e2e-cli/UC-014.test.ts that:
  ...
  - Commit: "green(cli): UC-014 CLI E2E"
```

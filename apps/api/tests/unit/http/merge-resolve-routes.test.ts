...
import { registerMergeResolveRoutes } from "../../../src/http/merge-resolve-routes.js";
...
describe("merge resolve routes", () => {
  test("rejects malformed resolution requests", async () => {
...
function registeredRoute(): Handler {
  ...
  if (handler === undefined) {
    throw new Error("expected merge resolve route");
  }
  return handler;
}

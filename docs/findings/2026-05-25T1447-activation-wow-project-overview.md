...
kind: snapshot
status_notes: |
  2026-06-03 (cycle 260603-01): re-verified — F1/F2 shipped (goals 32/33);
  snapshot kept as reference (kind: snapshot, NOT force-resolved). F3/F4 stay
  independent children, queued.

...
# Priority order:
#   1. Bootstrap (scaffolding, test framework, DB)
#   2. Continue an in-progress UC (failing tests exist)
#   3. Start the highest-priority not-yet-started UC
